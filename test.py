...
class MainScreen(MDScreen):
    ...
    def chrono_update(self, dt):
        ...
        self.ids.chrono_label.text = f"[b]{str(int(self.chrono_mins)).zfill(2)}[/b]:{str(int(self.chrono_secs)).zfill(2)}.{str(int((self.chrono_secs * 100) % 100)).zfill(2)}"
    ...
    def reset_chrono(self):
        ...
        try:
            ...
            print("idk")
        self.ids.chrono_label.text = "[b]00[/b]:00.00"
        self.total_seconds = 0
